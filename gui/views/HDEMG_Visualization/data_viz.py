...
class HDEMGVisualizationInterface(QMainWindow):
    ...
    def create_left_sidebar(self):
        ...
        # Frequency - REMOVED FROM DATA VISUALISATION
        ...
        # HP Filter - REMOVED FROM DATA VISUALISATION
        ...
        # LP Filter - REMOVED FROM DATA VISUALISATION
        ...
        # Refresh Rate - REMOVED FROM DATA VISUALISATION
    ...
    def create_visualization_area(self):
        ...
        # Initialize and Disconnect buttons - REMOVED FROM DATA VISUALISATION
